...
public class NavigationBarFragment extends Fragment implements Callbacks {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContentResolver.registerContentObserver(AsylumSettings.System.getUriFor(
                AsylumSettings.System.FULL_GESTURE_NAVBAR), false,
                mSettingsObserver, UserHandle.USER_ALL);
    ...
    private void setFullGestureMode() {
        boolean enabled = AsylumSettings.System.getIntForUser(mContentResolver,
                AsylumSettings.System.FULL_GESTURE_NAVBAR, 1, UserHandle.USER_CURRENT) == 1;
