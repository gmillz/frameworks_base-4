...
public class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String SYSTEMUI_NS = "http://schemas.android.com/apk/res-auto";
    ...
    public CustomSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        mMax = attrs.getAttributeIntValue(SYSTEMUI_NS, "maximum", 100);
        mMin = attrs.getAttributeIntValue(SYSTEMUI_NS, "minimum", 0);
        mDefaultValue = attrs.getAttributeIntValue(ANDROIDNS, "defaultValue", -1);
        mUnits = getAttributeStringValue(attrs, SYSTEMUI_NS, "units", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(SYSTEMUI_NS, "interval");
            if (newInterval != null)
