...
public class AlertSliderTile extends QSTileImpl<BooleanState>  {
    ...
    private static final Icon PRIORITY_ONLY =
    ...
    private boolean mDetailOnZenShown = false;
    ...
    private void setZenMode(int mode) {
        mNotificationManager.setZenModeWithLock(mode, null, TAG,
                mode != Settings.Global.ZEN_MODE_OFF);
    }
    ...
    public void showDetail(boolean show) {
        super.showDetail(show);
        mDetailOnZenShown = show;
    }

    private final ZenModeController.Callback mZenCallback = new ZenModeController.Callback() {
        public void onZenChanged(int zen) {
            if (mDetailOnZenShown) {
                mDetailAdapter.refresh(zen);
            }
            refreshState(zen);
        }
    };
    ...
    private final class AlertSliderDetailAdapter implements DetailAdapter {
        ...
        private RelativeLayout mRemindersSwitchContainer, mEventsSwitchContainer,
                mZenPriorityIntroduction;
        ...
        public View createDetailView(Context context, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                mMessageText = (TextView) details.findViewById(
                        R.id.alert_slider_introduction_message);
                mMessageBox = (RelativeLayout) details.findViewById(R.id.alert_slider_introduction);
                mZenPriorityIntroduction = (RelativeLayout) details.findViewById(
                        R.id.zen_introduction);
                mZenPriorityIntroductionConfirm = (ImageView) details.findViewById(
                        R.id.zen_introduction_confirm);
                mZenPriorityIntroductionConfirm.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Prefs.putBoolean(mContext, Prefs.Key.DND_CONFIRMED_PRIORITY_INTRODUCTION,
                                true);
                    }
                });
                mZenPriorityIntroductionCustomize = (TextView) details.findViewById(
                        R.id.zen_introduction_customize);
                ...
                mRemindersSwitchContainer = (RelativeLayout) details.findViewById(
                        R.id.switch_container_reminders);
                ...
                mReminders.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        MetricsLogger.action(mContext, MetricsEvent.ACTION_ZEN_ALLOW_REMINDERS,
                                isChecked);
                        if (DEBUG) Log.d(TAG, "onPrefChange allowReminders=" + isChecked);
                        savePolicy(getNewPriorityCategories(isChecked,
                                Policy.PRIORITY_CATEGORY_REMINDERS), mPolicy.priorityCallSenders,
                                mPolicy.priorityMessageSenders, mPolicy.suppressedVisualEffects);
                    }
                });
                mEventsSwitchContainer = (RelativeLayout) details.findViewById(
                        R.id.switch_container_events);
                ...
                mEvents.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        MetricsLogger.action(mContext, MetricsEvent.ACTION_ZEN_ALLOW_EVENTS,
                                isChecked);
                        if (DEBUG) Log.d(TAG, "onPrefChange allowEvents=" + isChecked);
                        savePolicy(getNewPriorityCategories(isChecked,
                                Policy.PRIORITY_CATEGORY_EVENTS), mPolicy.priorityCallSenders, 
                                mPolicy.priorityMessageSenders, mPolicy.suppressedVisualEffects);
                    }
                });
        ...
        private void refresh(int state) {
            switch(state) {
                case Settings.Global.ZEN_MODE_ALARMS:
                    ...
                    mButtons.setSelectedValue(Settings.Global.ZEN_MODE_ALARMS,
                            false /* fromClick */);
                ...
                case Settings.Global.ZEN_MODE_NO_INTERRUPTIONS:
                    // silent
                    mButtons.setVisibility(View.VISIBLE);
                    mButtons.setSelectedValue(Settings.Global.ZEN_MODE_NO_INTERRUPTIONS,
                            false /* fromClick */);
                    mMessageBox.setVisibility(View.VISIBLE);
                    mMessageText.setText(mContext.getString(
                ...
                case Settings.Global.ZEN_MODE_IMPORTANT_INTERRUPTIONS:
                    ...
                    // Prefs.getBoolean(mContext, Prefs.Key.DND_CONFIRMED_PRIORITY_INTRODUCTION,
                    //         false);
                ...
                default:
                    ...
                    mMessageBox.setVisibility(View.VISIBLE);
                    mMessageText.setText(mContext.getString(
                            R.string.quick_settings_alert_slider_detail_disabled_description));
                    mRemindersSwitchContainer.setVisibility(View.GONE);
                    mEventsSwitchContainer.setVisibility(View.GONE);
                    mZenPriorityIntroduction.setVisibility(View.GONE);
                    break;
